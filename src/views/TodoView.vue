  ...
  <div class="border border-slate-200 rounded-lg pt-4 pb-4 pl-5 pr-5 max-w-4xl mx-auto mt-5">
    ...
    <div class="mt-2">
      <input
        ...
        class="block w-full rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
      />
    </div>
    ...
    <div class="flex justify-end mt-5">
      <router-link to="/">
        <button
          class="text-zinc-900 pl-6 pr-6 h-9 rounded-lg font-medium mr-5 hover:text-red-800 hover:bg-slate-50"
        >
          Cancel
        </button>
      </router-link>
      <button
        class="bg-cyan-500 hover:bg-cyan-600 text-slate-50 pl-6 pr-6 h-9 rounded-lg font-medium"
        @click="saveForm()"
      >
        Save
      </button>
