  ...
  <main>
    <div class="mt-10 mb-2">
      ...
      <div v-if="items.length === 0">
        <p class="text-red-800 text-center my-5 font-semibold">
          You don't have any item to your list
        </p>
      </div>
    </div>

    <div
      class="flex border border-slate-200 rounded-lg pt-4 pb-4 pl-5 pr-5 justify-between items-center"
    >
